  ...
  meta: [
    {
      ...
      name: "description",
      // @ts-ignore
      content: `Политика в отношении обработки персональных данных. Свежие промокоды, скидки и акции на ${seo.month} 2022 год, а также эксклюзивные купоны. бегом za халявой!`,
    },
    {
      hid: "keywords",
      name: "keywords",
